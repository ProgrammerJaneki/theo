        ...
        <template x-if="fourthSlide">
            <div class="w-full overflow-hidden">
                <div class="flex items-center justify-center w-full animate__animated animate__fadeInUp">
                    ...
                    {{-- Right --}}
                    <div class="flex flex-col items-center overflow-auto justify-center w-5/12 h-screen min-h-[1024px] bg-[#4CAF50]">
                        {{-- Icon --}}
                        ...
                        <form class="flex flex-col gap-y-4 " action="">
                            ...
                            <div class="space-y-2">
                                ...
                                <input class="h-12 p-4 focus-within:ring-4 w-80 rounded-xl focus:outline-none"
                                    type="text">
                            </div>
                            <div class="space-y-2">
                            ...
                            <div
                                ...
                                <button class="flex items-center gap-x-2" type="button">
                                    ...
                                    <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 9L12 15L18 9" stroke="#333443" stroke-width="2"
