...
@section('login-signup')
    <div>
        <form action="" class="flex flex-col items-center gap-y-5 max-w-[359px]">
            {{-- Email --}}
            <div class="space-y-2">
            ...
            {{-- Send Email --}}
            <a class="flex justify-center items-center py-3 bg-[#FFE600] gap-x-3  rounded-xl w-80 hover:ring-4"
